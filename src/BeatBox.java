...
public class BeatBox {
    ...
    String[] instrmentNames = {"Bass Drum", "Closed Hi-Hat","Open Hi-Hat","Acoustic Snare","Crash Cymbal","Hand Clap",
    "High Tom","Hi Bongo", "Maracas","Whistle","Low Conga","Cowbell","Vibraslap","Low-mid Tom","High Agogo","Open Hi Conga"};
    int [] instruments = {35,41,46,38,49,39,50,60,70,72,64,56,58,47,67,63};
    ...
    public void buildGUI() {
        ...
        for(int i=0;i<16;i++) {
            nameBox.add(new Label(instrmentNames[i]));
        }
